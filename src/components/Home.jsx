...
import { Bell, ChevronDown } from 'lucide-react';
import logo from "../assets/rb_2147900929.png";
import { HiX } from "react-icons/hi";
import { useNavigate } from 'react-router-dom';
import '../styles/datepicker.css';
    ...
    return (
        <div className="flex bg-gray-100">
            ...
            <section className="flex flex-col">
                ...
                <aside className="w-[280px] bg-white p-6 border-r rounded-3xl mx-6 h-[300px]">
                    <nav className="space-y-4 text-xl">
                        <Link
                            to="/home"
                            className={`flex items-center space-x-3 p-2 rounded-sm transition-all duration-200 
                ${isActiveLink('/home')
                                    ...
                                    : 'text-black hover:text-black'}`}
                        >
                            <BsChatSquare className="w-7 h-7" />
                            <span>Chats</span>
                        </Link>
            ...
            <main className="flex-1 p-6 ">
                ...
                <>
                    ...
                    <div className="overflow-x-auto mt-10">
                        <table className="min-w-full table-auto bg-white border-collapse border border-gray-200 rounded-lg shadow-md">
                            <thead className="bg-gray-100">
                                <tr>
                                    ...
                                    <th className="p-3 text-left text-sm font-semibold text-gray-700">Profile Image</th>
                                </tr>
                            </thead>
                            <tbody>

                                <tr className="border-t hover:bg-gray-50">
                                    <td className="p-3 text-sm text-gray-700">{userData.username}</td>
                                    <td className="p-3 text-sm text-gray-700">{userData.email}</td>
